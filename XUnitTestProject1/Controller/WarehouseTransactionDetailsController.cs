...
{   
    public class warehouseTransactionDetailController
    {
        [Fact]
        public void warehouseTransactionDetail()
        {
            var client = new RestClient(ConfigTest.url+"warehouseTransactionDetails");
