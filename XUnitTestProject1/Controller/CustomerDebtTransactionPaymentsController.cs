...
{   
    public class customerDebtTransactionPaymentController
    {
        [Fact]
        public void customerDebtTransactionPayment()
        {
            var client = new RestClient(ConfigTest.url+"customerDebtTransactionPayments");
