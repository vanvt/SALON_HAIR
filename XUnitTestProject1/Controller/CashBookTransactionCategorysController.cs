...
{   
    public class cashBookTransactionCategoryController
    {
        [Fact]
        public void cashBookTransactionCategory()
        {
            var client = new RestClient(ConfigTest.url+"cashBookTransactionCategorys");
