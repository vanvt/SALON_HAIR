...
namespace SALON_HAIR_API.Controllers
{
    ...
    public class ProductSourcesController : CustomControllerBase
    {
        ...
        {
            var data = _productSource.SearchAllFileds(keyword);
        ...
        public async Task<IActionResult> PutProductSource([FromRoute] long id, [FromBody] ProductSource productSource)
        {
            ...
            try
            {
                productSource.UpdatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals(CLAIMUSER.EMAILADDRESS));
        ...
        public async Task<IActionResult> PostProductSource([FromBody] ProductSource productSource)
        {
            ...
            try
            {
                ...
                productSource.CreatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals(CLAIMUSER.EMAILADDRESS));
        ...
        private IQueryable<ProductSource> GetByCurrentSalon(IQueryable<ProductSource> data)
        {
