...
namespace SALON_HAIR_API.Controllers
{
    ...
    public class BookingStatussController : CustomControllerBase
    {
        ...
        {
            return OkList(_bookingStatus.Paging( _bookingStatus.SearchAllFileds(keyword),page,rowPerPage).Include(e=>e.Status));
        }
        ...
        public async Task<IActionResult> PutBookingStatus([FromRoute] long id, [FromBody] BookingStatus bookingStatus)
        {
            ...
            try
            {
                bookingStatus.UpdatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals("email"));
        ...
        public async Task<IActionResult> PostBookingStatus([FromBody] BookingStatus bookingStatus)
        {
            ...
            try
            {
                ...
                bookingStatus.CreatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals("email"));
