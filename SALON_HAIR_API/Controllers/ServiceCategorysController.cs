...
namespace SALON_HAIR_API.Controllers
{
    ...
    public class ServiceCategorysController : CustomControllerBase
    {
        ...
        public async Task<IActionResult> PutServiceCategory([FromRoute] long id, [FromBody] ServiceCategory serviceCategory)
        {
            ...
            try
            {
                serviceCategory.UpdatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals(CLAIMUSER.EMAILADDRESS));
        ...
        public async Task<IActionResult> PostServiceCategory([FromBody] ServiceCategory serviceCategory)
        {
            ...
            try
            {
                ...
                serviceCategory.CreatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals(CLAIMUSER.EMAILADDRESS));
        ...
        private IQueryable<ServiceCategory> GetByCurrentSalon(IQueryable<ServiceCategory> data)
        {
