...
namespace SALON_HAIR_API.Controllers
{
    ...
    public class SalonsController : CustomControllerBase
    {
        ...
        {
            var data = _salon.SearchAllFileds(keyword).Where
                (e => e.Id == JwtHelper.GetCurrentInformationLong(User, x => x.Type.Equals("salonId"))); ;
        ...
        public async Task<IActionResult> PutSalon([FromRoute] long id, [FromBody] Salon salon)
        {
            ...
            try
            {
                salon.UpdatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals("emailAddress"));
        ...
        public async Task<IActionResult> PostSalon([FromBody] Salon salon)
        {
            ...
            try
            {
                ...
                salon.CreatedBy = JwtHelper.GetCurrentInformation(User, e => e.Type.Equals("emailAddress"));
