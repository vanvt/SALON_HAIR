...
namespace SALON_HAIR_ENTITY.Entities
{
    public partial class salon_hairContext : DbContext
    {
        ...
        public virtual DbSet<BookingPrepayPayment> BookingPrepayPayment { get; set; }
        ...
        public virtual DbSet<CashBookTransactionCategory> CashBookTransactionCategory { get; set; }
        public virtual DbSet<CashBookTransactionDetail> CashBookTransactionDetail { get; set; }
        public virtual DbSet<CommissionArrangement> CommissionArrangement { get; set; }
        ...
        public virtual DbSet<StaffPackageCommissionTransaction> StaffPackageCommissionTransaction { get; set; }
        public virtual DbSet<StaffProductCommissionTransaction> StaffProductCommissionTransaction { get; set; }
        public virtual DbSet<StaffSalonBranch> StaffSalonBranch { get; set; }
        public virtual DbSet<StaffService> StaffService { get; set; }
        public virtual DbSet<StaffServiceCommissionTransaction> StaffServiceCommissionTransaction { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookingPrepayPayment>(entity =>
            {
                entity.ToTable("booking_prepay_payment");

                entity.HasIndex(e => e.BookingBankingId)
                    .HasName("booking_payment_banking_idx");

                entity.HasIndex(e => e.BookingId)
                    .HasName("booking_payment_booking_idx");

                entity.HasIndex(e => e.BookingMethodId)
                    .HasName("booking_payment_method_idx");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("booking_prepay_payment_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("booking_prepay_payment_salon_idx");

                entity.Property(e => e.Id)
                    .HasColumnName("id")
                    .HasColumnType("bigint(20)");

                entity.Property(e => e.BookingBankingId)
                    .HasColumnName("booking_banking_id")
                    .HasColumnType("bigint(20)");
                ...
                entity.Property(e => e.BookingMethodId)
                    .HasColumnName("booking_method_id")
                    .HasColumnType("bigint(20)");
                ...
                entity.HasOne(d => d.BookingBanking)
                    .WithMany(p => p.BookingPrepayPayment)
                    .HasForeignKey(d => d.BookingBankingId)
                    .HasConstraintName("booking_payment_banking");

                entity.HasOne(d => d.Booking)
                    .WithMany(p => p.BookingPrepayPayment)
                    .HasForeignKey(d => d.BookingId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("booking_payment_booking");

                entity.HasOne(d => d.BookingMethod)
                    .WithMany(p => p.BookingPrepayPayment)
                    .HasForeignKey(d => d.BookingMethodId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("booking_payment_method");

                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.BookingPrepayPayment)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("booking_prepay_payment_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.BookingPrepayPayment)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("booking_prepay_payment_salon");
            });
            ...
            modelBuilder.Entity<CashBook>(entity =>
            {
                ...
                entity.HasOne(d => d.PaymentMethod)
                    ...
                    .HasConstraintName("cash_book_payment");
            ...
            modelBuilder.Entity<CashBookTransaction>(entity =>
            {
                ...
                entity.HasIndex(e => e.CashBookTransactionCategoryId)
                    .HasName("cash_book_transaction_category_idx");

                entity.HasIndex(e => e.CustomerId)
                    .HasName("cash_book_transaction_customer_idx");

                entity.HasIndex(e => e.InvoiceId)
                    .HasName("cash_book_transaction_invoice_idx");

                entity.HasIndex(e => e.PaymentMethodId)
                    .HasName("cash_book_transaction_payment_idx");
                ...
                entity.HasIndex(e => e.StaffId)
                    .HasName("cash_book_transaction_staff_idx");
                ...
                entity.Property(e => e.CashBookTransactionCategoryId)
                    .HasColumnName("cash_book_transaction_category_id")
                    .HasColumnType("bigint(20)");
                ...
                entity.HasOne(d => d.CashBookTransactionCategory)
                    .WithMany(p => p.CashBookTransaction)
                    .HasForeignKey(d => d.CashBookTransactionCategoryId)
                    .HasConstraintName("cash_book_transaction_category");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CashBookTransaction)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("cash_book_transaction_customer");

                entity.HasOne(d => d.Invoice)
                    .WithMany(p => p.CashBookTransaction)
                    .HasForeignKey(d => d.InvoiceId)
                    .HasConstraintName("cash_book_transaction_invoice");

                entity.HasOne(d => d.PaymentMethod)
                    .WithMany(p => p.CashBookTransaction)
                    .HasForeignKey(d => d.PaymentMethodId)
                    .HasConstraintName("cash_book_transaction_payment");
                ...
                entity.HasOne(d => d.Staff)
                    ...
                    .HasConstraintName("cash_book_transaction_staff");
            });

            modelBuilder.Entity<CashBookTransactionCategory>(entity =>
            {
                entity.ToTable("cash_book_transaction_category");

                entity.HasIndex(e => e.SalonId)
                    .HasName("cash_book_transaction_category_salon_idx");
                ...
                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.CashBookTransactionCategory)
                    .HasForeignKey(d => d.SalonId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("cash_book_transaction_category_salon");
            });
            ...
            modelBuilder.Entity<CommissionArrangement>(entity =>
            {
                entity.ToTable("commission_arrangement");

                entity.HasIndex(e => e.InvoiceDetailId)
                    .HasName("commission_arrangement_invoice_detail_idx");

                entity.HasIndex(e => e.InvoiceId)
                    .HasName("commission_arrangement_invoice_idx");

                entity.HasIndex(e => e.SaleStaffId)
                    .HasName("commission_arrangement_sale_staff_idx");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("commission_arrangement_salon_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("commission_arrangement_salon_id_idx");

                entity.HasIndex(e => e.ServiceStaffId)
                    .HasName("commission_arrangement_service_staff_idx");
                ...
                entity.HasOne(d => d.InvoiceDetail)
                    .WithMany(p => p.CommissionArrangement)
                    .HasForeignKey(d => d.InvoiceDetailId)
                    .HasConstraintName("commission_arrangement_invoice_detail");

                entity.HasOne(d => d.Invoice)
                    .WithMany(p => p.CommissionArrangement)
                    .HasForeignKey(d => d.InvoiceId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("commission_arrangement_invoice");

                entity.HasOne(d => d.SaleStaff)
                    .WithMany(p => p.CommissionArrangementSaleStaff)
                    .HasForeignKey(d => d.SaleStaffId)
                    .HasConstraintName("commission_arrangement_sale_staff");

                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.CommissionArrangement)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("commission_arrangement_salon_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.CommissionArrangement)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("commission_arrangement_salon_id");

                entity.HasOne(d => d.ServiceStaff)
                    .WithMany(p => p.CommissionArrangementServiceStaff)
                    .HasForeignKey(d => d.ServiceStaffId)
                    .HasConstraintName("commission_arrangement_service_staff");
            });
            ...
            {
                entity.ToTable("customer_debt");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("customer_debt_branch_idx");
                ...
                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.CustomerDebt)
                    .HasForeignKey(d => d.SalonBranchId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("customer_debt_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.CustomerDebt)
                    .HasForeignKey(d => d.SalonId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("customer_debt_salon");
            });

            modelBuilder.Entity<CustomerDebtTransaction>(entity =>
            {
                ...
                entity.HasIndex(e => e.InvoiceId)
                    .HasName("customer_debt_transaction_invoice_idx");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("customer_debt_transaction_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("customer_debt_transaction_salon_idx");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.CustomerDebtTransaction)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("customer_debt_transaction_customer");

                entity.HasOne(d => d.Invoice)
                    .WithMany(p => p.CustomerDebtTransaction)
                    .HasForeignKey(d => d.InvoiceId)
                    .HasConstraintName("customer_debt_transaction_invoice");

                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.CustomerDebtTransaction)
                    .HasForeignKey(d => d.SalonBranchId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("customer_debt_transaction_branch");
            ...
            modelBuilder.Entity<CustomerPackage>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.SalonId, e.PackageId, e.CustomerId, e.Day, e.Month, e.Year })
                    .HasName("unique_index")
                    .IsUnique();
            ...
            modelBuilder.Entity<InvoiceDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.CustomerPackageId)
                    .HasName("invoice_detail_customer_package_idx");
                ...
                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("invoice_detail_salon_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("invoice_detail_salon_idx");
                ...
                entity.Property(e => e.CustomerPackageId)
                ...
                entity.HasOne(d => d.CustomerPackage)
                    .WithMany(p => p.InvoiceDetail)
                    .HasForeignKey(d => d.CustomerPackageId)
                    .HasConstraintName("invoice_detail_customer_package");
                ...
                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.InvoiceDetail)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("invoice_detail_salon_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.InvoiceDetail)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("invoice_detail_salon");
            });
            ...
            modelBuilder.Entity<InvoicePayment>(entity =>
            {
                ...
                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("invoice_payment_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("invoice_payment_salon_idx");
                ...
                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.InvoicePayment)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("invoice_payment_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.InvoicePayment)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("invoice_payment_salon");
            });
            ...
            {
                entity.ToTable("staff_package_commission_transaction");

                entity.HasIndex(e => e.PackageId)
                    .HasName("staff_package_commission_transaction_package_idx");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("staff_package_commission_transaction_salon_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("staff_package_commission_transaction_salon_idx");

                entity.HasIndex(e => e.StaffId)
                    .HasName("staff_package_commission_transaction_staff_idx");
                ...
                entity.HasOne(d => d.Package)
                    .WithMany(p => p.StaffPackageCommissionTransaction)
                    .HasForeignKey(d => d.PackageId)
                    .HasConstraintName("staff_package_commission_transaction_package");

                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.StaffPackageCommissionTransaction)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("staff_package_commission_transaction_salon_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.StaffPackageCommissionTransaction)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("staff_package_commission_transaction_salon");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.StaffPackageCommissionTransaction)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("staff_package_commission_transaction_staff");
            });

            modelBuilder.Entity<StaffProductCommissionTransaction>(entity =>
            {
                entity.ToTable("staff_product_commission_transaction");

                entity.HasIndex(e => e.ProductId)
                    .HasName("staff_product_commission_transaction_product_idx");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("staff_product_commission_transaction_salon_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("staff_product_commission_transaction_salon_idx");

                entity.HasIndex(e => e.StaffId)
                    .HasName("staff_product_commission_transaction_staff_idx");
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.StaffProductCommissionTransaction)
                    .HasForeignKey(d => d.ProductId)
                    .HasConstraintName("staff_product_commission_transaction_product");

                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.StaffProductCommissionTransaction)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("staff_product_commission_transaction_salon_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.StaffProductCommissionTransaction)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("staff_product_commission_transaction_salon");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.StaffProductCommissionTransaction)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("staff_product_commission_transaction_staff");
            });
            ...
            modelBuilder.Entity<StaffServiceCommissionTransaction>(entity =>
            {
                entity.ToTable("staff_service_commission_transaction");

                entity.HasIndex(e => e.SalonBranchId)
                    .HasName("staff_service_commission_transaction_salon_branch_idx");

                entity.HasIndex(e => e.SalonId)
                    .HasName("staff_service_commission_transaction_salon_idx");

                entity.HasIndex(e => e.ServiceId)
                    .HasName("staff_service_commission_transaction_service_idx");

                entity.HasIndex(e => e.StaffId)
                    .HasName("staff_service_commission_transaction_staff_idx");
                ...
                entity.HasOne(d => d.SalonBranch)
                    .WithMany(p => p.StaffServiceCommissionTransaction)
                    .HasForeignKey(d => d.SalonBranchId)
                    .HasConstraintName("staff_service_commission_transaction_salon_branch");

                entity.HasOne(d => d.Salon)
                    .WithMany(p => p.StaffServiceCommissionTransaction)
                    .HasForeignKey(d => d.SalonId)
                    .HasConstraintName("staff_service_commission_transaction_salon");

                entity.HasOne(d => d.Service)
                    .WithMany(p => p.StaffServiceCommissionTransaction)
                    .HasForeignKey(d => d.ServiceId)
                    .HasConstraintName("staff_service_commission_transaction_service");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.StaffServiceCommissionTransaction)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("staff_service_commission_transaction_staff");
            });
